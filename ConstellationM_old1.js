...
const plotSignal = () => {
    ...
    for (let i = 0; i < numSamples; i++) {
        let real1 = Math.round(Math.random())*2-1 + gaussianRandom(0, noiseLevel);
        let imag1 = Math.round(Math.random())*2-1 + gaussianRandom(0, noiseLevel);
        signal1.push(math.complex(real1, imag1));
        let real2 = Math.round(Math.random())*2-1 + gaussianRandom(0, noiseLevel);
        let imag2 = Math.round(Math.random())*2-1 + gaussianRandom(0, noiseLevel);
